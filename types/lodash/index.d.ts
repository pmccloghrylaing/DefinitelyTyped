...
declare namespace _ {
    ...
    **/
    ...
    interface LoDashStatic {
         ...
         */
        unionBy<T>(
            array1: List<T> | null | undefined,
            array2: List<T> | null | undefined,
            iteratee?: ValueIteratee<T>
        ): T[];
    ...
    interface LoDashStatic {
        ...
        zipWith<T1, T2, TResult>(
            array1: List<T1> | null | undefined,
            array2: List<T2> | null | undefined,
